...
$cssPath = __DIR__ . '/../../public/dist/admin/supplier-manage.css';
$jsPath = __DIR__ . '/../../public/dist/admin/supplier-manage.js';
$cssVersion = file_exists($cssPath) ? filemtime($cssPath) : time();
$jsVersion = file_exists($jsPath) ? filemtime($jsPath) : time();

$additionalCSS = [
    BASE_URL . 'public/dist/admin/supplier-manage.css?v=' . $cssVersion,
];
...
<script type="module" nonce="<?= defined('CSP_NONCE') ? CSP_NONCE : '' ?>" src="<?= BASE_URL ?>public/dist/admin/supplier-manage.js?v=<?= $jsVersion ?>"></script>
