...
$additionalCSS = [
    BASE_URL . 'public/dist/admin/booking-manage.css?v=' . rawurlencode(ASSET_VERSION),
];
...
<script type="module" nonce="<?= defined('CSP_NONCE') ? CSP_NONCE : '' ?>" src="<?= BASE_URL ?>public/dist/admin/booking-manage.js?v=<?= rawurlencode(ASSET_VERSION) ?>"></script>
