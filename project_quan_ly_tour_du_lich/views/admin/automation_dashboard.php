...
$additionalCSS = [
    BASE_URL . 'public/dist/admin/automation-dashboard.css?v=' . rawurlencode(ASSET_VERSION),
];
...
<script type="module" nonce="<?= defined('CSP_NONCE') ? CSP_NONCE : '' ?>" src="<?= BASE_URL ?>public/dist/admin/automation-dashboard.js?v=<?= rawurlencode(ASSET_VERSION) ?>"></script>
